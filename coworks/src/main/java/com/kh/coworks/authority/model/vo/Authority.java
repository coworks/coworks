...
public class Authority implements Serializable {
	...
	public Authority(int emp_no, String auth_personnal, String auth_data, String auth_cal, String auth_board,
	...
	public String toString() {
		return "Authority [emp_no=" + emp_no + ", auth_personnal=" + auth_personnal + ", auth_data=" + auth_data
				+ ", auth_cal=" + auth_cal + ", auth_board=" + auth_board + ", auth_approval=" + auth_approval
