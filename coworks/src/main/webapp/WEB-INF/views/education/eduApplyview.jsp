                            ...
                            <div class="card-body"> 
                               <div class=" align-self-center">
                                     ...
                                     <h3 class="card-title mb-7">교육 신청 현황</h3>
	                      			  ...
	                      			  <div class="dropdown float-right ">
				                            ...
				                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton"> 
				                            	...
				                            	<input type="button" class="dropdown-item" id="type5" name="type5" value='기타' onclick="fnonclick('기타')"/> 
				                            </div>
				                      </div> 
									...
									function fnonclick(type){
										location.href="${pageContext.request.contextPath}/education/searchTypeEducation.do?edu_type="+type;
									}
	                                 ...
	                                 <div class="jsgrid-grid-header jsgrid-header-scrollbar">
										<table class="jsgrid-table table table-striped table-hover ">
											<tr class="jsgrid-header-row">
												...
												<th
													class="jsgrid-header-cell  jsgrid-align-center jsgrid-header-sortable"
													style="width: 30px;">교육유형</th>
												<th
													class="jsgrid-header-cell  jsgrid-align-center jsgrid-header-sortable"
													style="width: 70px;">교육명</th>
												<th
													class="jsgrid-header-cell jsgrid-align-center jsgrid-header-sortable"
													style="width: 50px;">강사</th> 
												<th
													class="jsgrid-header-cell jsgrid-control-field jsgrid-align-center"
													style="width: 40px;">교육일시
											...
											<tbody> 
			                                 ...
			                                 <tr class="jsgrid-row" onclick="location.href='${pageContext.request.contextPath}/education/eduDetail.do?edu_no=${list.edu_no}'">
			                                    <td class="jsgrid-cell jsgrid-align-center"
																style="width: 30px;">${idx.count}</td>
			                                   <td class="jsgrid-cell jsgrid-align-center"
																style="width: 30px;">${list.edu_type}</td>
			                                    <td class="jsgrid-cell jsgrid-align-center"
																style="width: 70px;" id="title">
			                                       
			                                          ${list.edu_title}
		                                       
		                                    </td>
		                                    <td class="jsgrid-cell jsgrid-align-center"
															style="width: 50px;">${list.edu_instructor}</td>
		                                    <td class="jsgrid-cell jsgrid-align-center"
															style="width: 40px;">${edudate}</td>
		                                     
		                                    <td class="jsgrid-cell jsgrid-align-center"
															style="width: 40px;"  onclick="event.cancelBubble=true"> 
