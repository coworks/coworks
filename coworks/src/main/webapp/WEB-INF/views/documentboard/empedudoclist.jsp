			...
			<div class="container-fluid">
				...
				<div class="card">
					...
					<!-- -->
                        ...
                        <h3 class="text-themecolor mb-0 mt-0">COWORKS 통합자료실 > 교육문서</h3>
                        <br><br>
                   		</div>
						<!-- -->
						<!-- <h4 class="card-title">COWORKS 통합자료실 > 교육문서</h4>
						<h6 class="card-subtitle">교육관련문서</h6> -->
						<div class="table-responsive">
							<div style="text-align : right;"><a href="empedudocdetail.do" class="btn btn-danger waves-effect waves-light">상세보기</a></div>
							<div style="text-align : right;"><a href="empedudoc.do" class="btn btn-danger waves-effect waves-light">글쓰기</a></div>
							<table id="demo-foo-pagination"
								...
								<tbody>
									<tr>
										<td>index</td>
										<td class="text-al-left">교육신청서<span class="badge badge-danger ml-auto">new</span></td>
										<td>2019-07-18</td>
									...
									<tr>
										<td>index</td>
										<td class="text-al-left">월별교육계획서</td>
										<td>2019-07-18</td>
										<td><div data-icon="&#xe019"
												class="linea-icon linea-basic">
												<div></td>
									...
									<tr>
										<td>index</td>
										<td class="text-al-left">분기별교육계획서</td>
										<td>2019-07-18</td>
										<td><div data-icon="&#xe019"
												class="linea-icon linea-basic">
												<div></td>
									...
									<tr>
										<td>index</td>
										<td class="text-al-left">연간교육계획서</td>
										<td>2019-07-18</td>
										<td><div data-icon="&#xe019"
												class="linea-icon linea-basic">
												<div></td>
									...
									<tr>
										<td>index</td>
										<td class="text-al-left">교육보고서</td>
										<td>2019-07-18</td>
										<td><div data-icon="&#xe019"
												class="linea-icon linea-basic">
												<div></td>
									...
									<tr>
										<td>index</td>
										<td class="text-al-left">교육목표보고서</td>
										<td>2019-07-18</td>
										<td><div data-icon="&#xe019"
												class="linea-icon linea-basic">
												<div></td>
