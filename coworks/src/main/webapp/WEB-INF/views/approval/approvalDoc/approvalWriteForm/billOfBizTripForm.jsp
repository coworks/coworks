									...
									<form id="tableForm" onsubmit="return check()">
										<div class="table-responsive mt-2">
											...
											<table class="table table-bordered no-wrap">
												<thead>
													<tr id="header">
														<th scope="col" class="border">일자</th>
														<th scope="col" class="border">교통비</th>
														<th scope="col" class="border">숙박비</th>
														<th scope="col" class="border">기타잡비</th>
														<th scope="col" class="border">일일지출</th>
													</tr>
												</thead>
												<tbody>
										...
										<div align="right">
											<input type="button" id="submit" value="제출하기" class="btn btn-info" /> <input type="button" value="취소" class="btn btn-danger" onclick="javascript:history.back()" />
										</div>
									</form>
								</div>
							</div>
