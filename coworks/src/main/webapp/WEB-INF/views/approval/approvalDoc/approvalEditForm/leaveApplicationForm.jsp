...
<body class="fix-header fix-sidebar card-no-border">
						...
						<div class="card">
							<div class="card-body">
								<div style="width: 80%; margin-left: auto; margin-right: auto;">
									<h2 class="card-title mb-5">휴가 신청서 수정하기</h2>
									<form action="${pageContext.request.contextPath }/approval/editApprovalDone" method="post" enctype="multipart/form-data">
										<div class="mt-2">
	...
	<script>
		$(function() {
			...
			$('[name=vacation_Etc]').val(content.vacation_Etc);
			$('[name=vacation_type]').val(content.vacation_type);
			$('[name=vacation_range]').val(content.vacation_range);
			$('[name=vacation_reason]').val(content.vacation_reason);			
