   ...
   <div class="scroll-sidebar">
      ...
      <nav class="sidebar-nav">
         <ul id="sidebarnav">
            ...
            <li><a href="${pageContext.request.contextPath}/todo/todolist.do" aria-expanded=false"><i class="mdi mdi-checkbox-multiple-marked"></i><span class="hide-menu">TODO</span></a></li>
            <li><a href="#" aria-expanded="false"><i class="mdi mdi-message-text-outline"></i><span class="hide-menu">메신저</span></a></li>
            <li><a class="has-arrow " href="#" aria-expanded="false"><i class="mdi mdi-pen"></i><span class="hide-menu">전자결재</span></a>
               <ul aria-expanded="false" class="collapse">
                  <li><a href="${pageContext.request.contextPath}/approval/approvalSelectForm.do">작성하기</a></li>
                  <li><a href="${pageContext.request.contextPath}/approval/approvalWait.do">상신 / 기안함</a></li><!-- 내가 결재서류 올리고 아직 완료되지 않은 문서 -->
                  <li><a href="${pageContext.request.contextPath}/approval/approvalSubmit.do">승인 / 반려함</a></li><!-- 내가 결재서류 올리고 모든 결재가 끝난 문서 -->
                  <li><a href="${pageContext.request.contextPath}/approval/approvalReceive.do">미결함</a></li><!-- 내가 결재해야할 문서 -->
