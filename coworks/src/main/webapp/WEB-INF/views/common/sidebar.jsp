         ...
         <ul id="sidebarnav">
            ...
            <li><a class="has-arrow " href="#" aria-expanded="false"><i class="mdi mdi-pen"></i><span class="hide-menu">전자결재</span></a>
               <ul aria-expanded="false" class="collapse">
                  ...
                  <li><a href="${pageContext.request.contextPath}/approval/approvalYet.do">상신 / 기안함</a></li><!-- 내가 결재서류 올리고 아직 완료되지 않은 문서 -->
                  <li><a href="${pageContext.request.contextPath}/approval/approvalComplete.do">승인 / 반려함</a></li><!-- 내가 결재서류 올리고 모든 결재가 끝난 문서 -->
