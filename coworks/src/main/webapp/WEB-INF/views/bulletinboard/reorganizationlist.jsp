...
<head>
<meta charset="UTF-8">
<title>CO-WORKS : 조직개편 및 인사발령</title>
			...
			<div class="container-fluid">
				...
				<div class="card">
					<div class="card-body">
                        ...
                        <h3 class="text-themecolor mb-0 mt-0">COWORKS 게시판 > 조직개편 및 인사발령</h3>
                        <br><br>
                   		</div>
						...
						<div style="text-align : right;"><a href="reorganizationdetail.do" class="btn btn-danger waves-effect waves-light">상세보기</a></div>
						<div style="text-align : right;"><a href="reorganizationForm.do" class="btn btn-danger waves-effect waves-light">글쓰기</a></div>
							<table id="demo-foo-pagination"
								...
								<tbody>
									<tr>
										<td>index</td>
										<td class="text-al-left">2019조직개편 및 인사발령 <span class="badge badge-danger ml-auto">new</span></td>
									...
									<tr>
										<td>index</td>
										<td class="text-al-left">2018조직개편 및 인사발령 </td>
										<td><i class="fa fa-paperclip"></i></td>
										<td>작성자1</td>
										<td>2018-01-01</td>
									</tr>
									<tr>
										<td>index</td>
										<td class="text-al-left">2017조직개편 및 인사발령</td>
										<td><i class="fa fa-paperclip"></i></td>
										<td>작성자1</td>
										<td>2017-01-01</td>
									</tr>
									<tr>
										<td>index</td>
										<td class="text-al-left">2016조직개편 및 인사발령</td>
										<td><i class="fa fa-paperclip"></i></td>
										<td>작성자1</td>
										<td>2016-01-01</td>
									</tr>
									<tr>
										<td>index</td>
										<td class="text-al-left">2015조직개편 및 인사발령</td>
										<td><i class="fa fa-paperclip"></i></td>
										<td>작성자1</td>
										<td>2015-01-01</td>
									</tr>
									<tr>
										<td>index</td>
										<td class="text-al-left">2014조직개편 및 인사발령</td>
										<td><i class="fa fa-paperclip"></i></td>
										<td>작성자1</td>
										<td>2014-01-01</td>
									</tr>
									<tr>
										<td>index</td>
										<td class="text-al-left">2013조직개편 및 인사발령</td>
										<td><i class="fa fa-paperclip"></i></td>
										<td>작성자1</td>
										<td>2013-01-01</td>
									</tr>
									<tr>
										<td>index</td>
										<td class="text-al-left">2012조직개편 및 인사발령</td>
										<td><i class="fa fa-paperclip"></i></td>
										<td>작성자1</td>
										<td>2012-01-01</td>
									</tr>
