			...
			<div class="container-fluid">
				...
				<div class="card">
					<div class="card-body">
                        ...
                        <h3 class="text-themecolor mb-0 mt-0">COWORKS 게시판 > 자유게시판</h3>
                        <br><br>
                   		</div>
						...
						<div style="text-align : right;"><a href="bulletinboarddetail.do" class="btn btn-danger waves-effect waves-light">상세보기</a></div>
						<div style="text-align : right;"><a href="bulletinboardForm.do" class="btn btn-danger waves-effect waves-light">글쓰기</a></div>
							<table id="demo-foo-pagination"
								...
								<tbody>
									<tr>
										<td>index</td>
										<td class="text-al-left">자유게시판 <span class="badge badge-danger ml-auto">new</span></td>
